...
class UserRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    public function getUserStats(): array
    {
        ...
        // Considérer tous les utilisateurs comme actifs pour l'instant
        // car il n'y a pas de propriété isActive
        $active = $total;
        ...
        return [
            ...
            'active' => (int) $active,
            'admin' => (int) $admin,
            'inactive' => 0 // Pas d'utilisateurs inactifs pour l'instant
        ];
    }
